...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" action="{{route('materi.store')}}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="first-name-horizontal" class="form-control" name="judul">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text" id="contact-info-horizontal" class="form-control" name="link_materi">
                            </div>
                            <div class="col-md-4">
